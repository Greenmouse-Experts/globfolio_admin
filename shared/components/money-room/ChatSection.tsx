...
} from "@/services/api/chatSlice";
import { toast } from "react-toastify";
import EditRoom from "./Chats/EditRoom";
...
const ChatSection: FC<Props> = ({ item, socket, select, refetchRoom }) => {
  ...
  return (
    <>
            ...
            <>
              <Menu placement="bottom-end">
                ...
                <MenuList className="p-2">
                  <MenuItem onClick={() => setViewUser(true)}>
                    View Users
                  </MenuItem>
                  <MenuItem onClick={() => setViewFiles(true)}>
                    View Files
                  </MenuItem>
                  <MenuItem
      ...
      <Edit title="Update Chat room details">
        <EditRoom
          data={item}
          refetch={refetchRoom}
